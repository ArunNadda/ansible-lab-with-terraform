...
resource "aws_instance" "node1" {
  ...
  count = 3
  tags = {
    Name = "${var.prefix}-tf-ansible-node"
  }
}
...
resource "aws_instance" "controlnode" {
  ...
  provisioner "file" {
    source = "/Users/anamikanadda/Documents/AKN_AWS/terraform_code/ansible.cfg"
    destination = "~/ansible.cfg"
  }


  provisioner "file" {
    source = "/Users/anamikanadda/Documents/AKN_AWS/terraform_code/inventory"
    destination = "~/inventory"
  }

  provisioner "file" {
    source = "/Users/anamikanadda/Documents/AKN_AWS/KP.pem"
    destination = "~/kp.pem"
  }
